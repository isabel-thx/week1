...
p grab_all_ssns("234-60-1422, 350-80-0744, 013-60-8762") == ["234-60-1422", "350-80-0744", "013-60-8762"]
...
def hide_all_ssns(string)
  if string.match(/\d{3}-\d{2}-\d{4}/)
    arr_ssn = string.scan(/\d{3}-\d{2}-\d{4}/)
    ssn_list = arr_ssn.join(', ')
    return ssn_list.gsub(/(\d{3})-(\d{2})-(\d{4})/, 'XXX-XX-\3')
  else
    return string
  end
end
